...
patch -p1 -o src_rtl/aes_core_dual_fast.v aes/src/rtl/aes_core.v < patches/aes_core.patch
patch -p1 -o src_rtl/aes_encipher_block_dual.v aes/src/rtl/aes_encipher_block.v < patches/aes_encipher.patch
...
patch -p1 -o src_rtl/aes_key_mem_stream.v aes/src/rtl/aes_key_mem.v < patches/aes_key_mem.patch