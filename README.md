# Mirath in HW
This repository contains the (System)Verilog RTL sources of an efficient HW (FPGA) implementation of [Mirath](https://pqc-mirath.org/index.html), an MPC-in-the-Head-based post-quantum digital signature algorithm. 
...
Our paper describing the design be found on [IACR ePrint](https://eprint.iacr.org/2026/206).
